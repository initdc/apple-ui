<template>
  ...
  <Affix title='iMac 24"' subtitle="Preview" link="/" class="ap-affix">
    <ul>
      <li>Overview</li>
      <li><a href="/">Tech Specs</a></li>
    </ul>
    <Button class="ap-button">View pricing</Button>
  </Affix>
  <notify>
    <a href="/">
  ...
  <bread>
    ...
    <bread-item>c</bread-item>
    <bread-item>d</bread-item>
  </bread>
  <Footer>
    <break></break>
    <ol class="note">
      ...
      <li>      Magic Keyboard with Touch ID is included with the 24‑inch iMac systems with Apple M1 chip and 8‑core GPU and is available as an option on systems with 7‑core GPU.
      </li>
      <li>      Trade-in values vary based on the condition, year, and configuration of your trade-in device, and may also vary between online and in-store trade-in. You must be at least 18 years old. Apple or its trade-in partners reserve the right to refuse or limit any trade-in transaction for any reason. In-store trade-in requires presentation of a valid, government-issued photo ID (local law may require saving this information). Additional terms from Apple or Apple’s trade-in partners may apply.
        <br>
        <br>
    ...
    <p  class="note">
      † Apple Card Monthly Installments is available for certain Apple products and is subject to credit approval and credit limit. See https://support.apple.com/kb/HT211204 for more information about eligible products. iPhone activation required on iPhone purchases made at an Apple Store with one of these national carriers: AT&T, Sprint, Verizon, or T‑Mobile. Variable APRs for Apple Card other than Apple Card Monthly Installments range from 10.99% to 21.99% based on creditworthiness. Rates as of April 1, 2020. Taxes and shipping are not included in Apple Card Monthly Installments and are subject to your standard purchase APR. See the Apple Card Customer Agreement for more information.
      To access and use all the features of Apple Card, you must add Apple Card to Wallet on an iPhone or iPad with iOS or iPadOS 13.2 or later. Update to the latest version of iOS or iPadOS by going to Settings > General > Software Update. Tap Download and Install. Available for qualifying applicants in the United States. Apple Card is issued by Goldman Sachs Bank USA, Salt Lake City Branch.
    </p>
    <break></break>
    <bread>
      <ul class="flex">
        <bread-item><span class="icon material-icons">home</span></bread-item>
        <bread-item>Mac</bread-item>
        <bread-item>iMac</bread-item>
